        ...
        <div className="border-t border-ink/20 pt-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex-1 border-2 border-ink bg-cyan px-4 py-2 text-sm font-semibold text-ink shadow-[3px_3px_0_#241B35] active:shadow-none active:translate-x-0.75 active:translate-y-0.75 disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none disabled:active:translate-x-0 disabled:active:translate-y-0"
            >
              Add to page
            </button>
          </div>
          <button
            ...
            className="mt-3 w-full border-2 border-ink bg-green px-4 py-2.5 text-sm font-semibold text-ink shadow-[3px_3px_0_#241B35] active:shadow-none active:translate-x-0.75 active:translate-y-0.75 disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none disabled:active:translate-x-0 disabled:active:translate-y-0"
          >
    ...
    <div className="min-h-screen bg-lavender text-ink antialiased">
      <div className="mx-auto flex min-h-screen w-full max-w-360 flex-col px-3 py-5 sm:px-5 sm:py-7 lg:px-8">
        ...
        <main className="flex-1 border-2 border-ink bg-paper p-3 shadow-[4px_4px_0_#241B35] sm:p-5 lg:p-7">
          {error && (
            <div className="mb-5 w-full border-2 border-ink bg-coral/10 px-4 py-3 text-sm text-coral sm:px-5">
              <p>{error}</p>
              <button
              ...
              {!pdf ? (
                ...
                <>
                  <div className="mb-4 flex min-w-0 items-center gap-3 border-b-2 border-ink/20 pb-4">
                    ...
                    <button
                      onClick={handleResetPdf}
                      className="shrink-0 border-2 border-ink/30 bg-paper px-2 py-1 text-sm text-ink shadow-[2px_2px_0_#241B35] active:shadow-none active:translate-x-0.5 active:translate-y-0.5"
                    >
                      Reset
                    </button>
                  </div>
      ...
      <button
        ...
        className="fixed right-4 bottom-4 z-40 flex items-center gap-2 border-2 border-ink bg-cyan px-5 py-3 text-sm font-semibold text-ink shadow-[3px_3px_0_#241B35] active:shadow-none active:translate-x-0.75 active:translate-y-0.75 lg:hidden"
      >
          ...
          >
            <div className="mb-4 flex items-center justify-between gap-4 border-b-2 border-ink/20 pb-3">
              ...
              <button
                ...
                className="border-2 border-ink/30 px-3 py-1.5 text-xl leading-none text-ink active:bg-ink/10"
              >
                ×
              </button>
            </div>
